...
export const mockTasks: Task[] = [
  ...
  },
  {
    ...
    campaignId: 'camp-001',
    type: 'hold_token',
    title: 'Hold ≥1 USDC on Base',
    description:
      'Connect your wallet and we will read your USDC balance on Base directly from chain. No backend required.',
    points: 500,
    status: 'available',
    proofType: 'auto',
    order: 4,
  ...
  },
  {
    ...
    campaignId: 'camp-001',
    type: 'hold_nft',
    title: 'Hold any Base Bridge NFT',
    description:
      'Hold at least 1 commemorative Base Introduced NFT. Read live from Base via your connected wallet.',
    points: 250,
    status: 'available',
    proofType: 'auto',
    order: 5,
    onchain: {
      chain: 'BASE',
      contractAddress: '0xeA2a41c02fA86A4901826615F9796e603C6a4491',
      minBalance: 1,
      symbol: 'Base Introduced',
    },
  },
  {
    id: 'task-005',
